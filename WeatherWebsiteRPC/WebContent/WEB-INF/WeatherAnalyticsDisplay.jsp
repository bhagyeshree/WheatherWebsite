...
body { 
background-image: url("http://localhost:8080/WeatherWebsiteRPC/images/bg.jpg"); 
...
#map {
 ...
 #placeholder { width: 500px; height: 180px; position: relative; margin: 0 auto; }
...
<div class="well">
   ...
   <h1> <b>${current}</b>°<small><a href="WeatherAnalyticsDisplay?newLocation=${newLocation}&m=C">C</a> |</small>°<small><a href="WeatherAnalyticsDisplay?newLocation=${newLocation}&m=F">F</a></small></h1> 
   Max : ${max} , Min : ${min}
...
<div class="well">
   <h4><b>Average Details : <small>(16Days)</small></b></h4>
   Temperature : ${averageTemperature}°
   <br>
   Humidity : ${averageHumidity}%
   <br>
   Pressure : ${averagePressure} hPa
   <br>
   Speed : ${averageSpeed} meter/sec
   <br>
   Wind Degree : ${averageWindDegree}°
   <br>
   Clouds : ${averageClouds}%
</div>
</td>
...
<tr>
<th>Date</th><th>Main Weather</th><th>Description</th><th>Pressure hPa</th><th>Humidity %</th><th>Speed meter/sec</th><th>Wind Degree °</th><th>Clouds %</th>
</tr>
<c:forEach items="${ cityInfo.temperatureList }" var="temp">
<tr>
<td><fmt:formatDate pattern="MM-dd-yyyy" value="${temp.date}" /></td>
<td>${temp.weatherMain}</td>
<td>${temp.description}</td>
<td>${temp.pressure}</td>
<td>${temp.humidity}</td>
<td>${temp.speed}</td>
<td>${temp.windDegree}</td>
<td>${temp.clouds}</td>
</tr>
</c:forEach>
</table>
